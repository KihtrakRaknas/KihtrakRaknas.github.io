                ...
                fetch(!this.noCloudImg ? firstDateLink : 'https://wordpress-redirect.herokuapp.com/?url=' + encodeURIComponent(firstDateLink)).then(response => {
                    response.json().then(json => {
                        if (!json.message) {
                            ...
                            this.setState({
                                description: "Additional details couldn't be loaded in. Try again tomorrow or use a different network.",
            ...
            <div className="card" data-filter={JSON.stringify(filterTerms)} style={{...(this.props.width ? { width: (this.props.width - 20 * (columns - 1)) / columns } : {}), boxShadow: "3px 3px 10px gray"}}>
                ...
                <div className="card-body">
                    ...
                    <div className="d-flex justify-content-around" style={{ flexWrap: "wrap" }}>
                        {this.props.iOSDownload ? <a target="_blank" style={{ marginTop: 2, marginBottom: 2 }} href={this.props.iOSDownload}><img alt='Get it on the Apple App Store' src={require('../Imgs/App_Store_Badge.svg')} style={{ height: 37.6 }} loading="lazy"/></a> : null}
                        {this.props.androidDownload ? <a target="_blank" style={{ marginTop: 2, marginBottom: 2 }} href={this.props.androidDownload}><img alt='Get it on Google Play' src={require('../Imgs/google-play-badge.png')} style={{ height: 37.6 }} loading="lazy"/></a> : null}
